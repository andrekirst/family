        ...
        <div class="bg-gradient-to-r from-purple-600 to-pink-600 px-6 py-4">
          <div class="flex items-center space-x-4">
            ...
            <div>
              ...
              <p class="text-purple-100 text-sm">Familienmitglieder und Beziehungen</p>
            </div>
          </div>
        </div>
        ...
        <div class="p-6">
          <div class="space-y-4">
            <p class="text-gray-700 text-base">
              Verwalten Sie hier alle Familienmitglieder, Rollen und Beziehungen.
            </p>
              ...
              <div class="space-y-4">
                ...
                <button class="w-full border-2 border-dashed border-gray-300 rounded-lg p-4 hover:border-purple-400 transition-colors group">
                  <div class="flex items-center justify-center space-x-2 text-gray-600 group-hover:text-purple-600">
                    ...
                    <span class="text-sm font-medium">Familienmitglied hinzufügen</span>
                  </div>
                </button>
              </div>
            </div>
