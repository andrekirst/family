      ...
      <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-purple-600 to-pink-600 px-6 py-4">
          <div class="flex items-center space-x-4">
            ...
            <!-- Title and Subtitle -->
            <div>
              <h1 class="text-2xl font-bold text-white">Familienverwaltung</h1>
              <p class="text-purple-100 text-sm">Verwalten Sie Ihre Familie und deren Mitglieder</p>
            </div>
          </div>
        </div>
        ...
        <div class="p-6">
          <div class="space-y-4">
            <p class="text-gray-700 text-base">
              Organisieren Sie Ihre Familie zentral und behalten Sie den Überblick über alle wichtigen Informationen.
            </p>
          ...
          <div class="mt-8">
            <!-- Family Overview -->
            <div class="mb-8">
              <h2 class="text-xl font-semibold text-gray-900 mb-4">Familienübersicht</h2>
              <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="bg-gray-50 rounded-lg p-4">
                  <div class="flex items-center justify-between mb-2">
                    <span class="text-sm font-medium text-gray-600">Mitglieder</span>
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                  <div class="flex items-center justify-between mb-2">
                    <span class="text-sm font-medium text-gray-600">Kinder</span>
                    <svg class="w-5 h-5 text-gray-400" aria-hidden="true" viewBox="0 0 24 24">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                  <div class="flex items-center justify-between mb-2">
                    <span class="text-sm font-medium text-gray-600">Administratoren</span>
                    <svg class="w-5 h-5 text-gray-400" aria-hidden="true" viewBox="0 0 24 24">
            ...
            <!-- Family Members List -->
            <div>
              <h2 class="text-xl font-semibold text-gray-900 mb-4">Familienmitglieder</h2>
              <div class="space-y-4">
                <!-- Member Card 1 -->
                ...
                <button class="w-full border-2 border-dashed border-gray-300 rounded-lg p-4 hover:border-purple-400 transition-colors group">
                  <div class="flex items-center justify-center space-x-2 text-gray-600 group-hover:text-purple-600">
                    ...
                    <span class="text-sm font-medium">Mitglied hinzufügen</span>
                  </div>
                </button>
              </div>
            </div>
